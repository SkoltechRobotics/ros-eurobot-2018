...
def stm_coordinates_callback(data):
    ...
    poses = [Pose(Point(x=particle_filter.particles[i,0]/1000, y=particle_filter.particles[i,1]/1000, z=.5), tf.transformations.quaternion_from_euler(0, 0, particle_filter.particles[i,2])) for i in range(len(particle_filter.particles))]
