...
class BehaviorTreeBuilder:
    ...
    def add_disposal_secondary(self, parent_name):
        ...
        if self.side == "orange":
            ...
            self.add_action_node(main_seq_name, "move_odometry", self.move_publisher_name, self.move_response, "move_odometry", 1.9, 0.21, 3.14)
            self.add_command_action(main_seq_name, 194, 2) # manipulators
            ...
            self.add_action_node(main_seq_name, "move_odometry", self.move_publisher_name, self.move_response, "move_odometry", 1.9, 0.4, 0)
            self.add_action_node(main_seq_name, "move", self.move_publisher_name, self.move_response, "move", 1.65, 0.11, 0, 0, 0, 1)
