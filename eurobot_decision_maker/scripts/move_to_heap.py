...
if __name__  == '__main__':
    ...
    move_message.goal.target_pose.pose.position.x = 0
    move_message.goal.target_pose.pose.position.y = 0
    ...
    nav_move = ActionNode("nav_move", pub_move, move_message, sub_response_name)
